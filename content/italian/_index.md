---
banner:
  title: "Campionati della Matematica <br> Distretto di Treviso"
  content: "Il punto di riferimento per studenti e docenti del Distretto di Treviso che vogliono conoscere, preparare e vivere i Campionati della Matematica.<br><br>
  La scuola polo del distretto, responsabile della messa a disposizione delle risorse necessarie per l’organizzazione delle gare distrettuali e della relativa cerimonia di premiazione, è il [Liceo Scientifico Statale **Leonardo da Vinci**](https://liceodavinci.edu.it) di Treviso."
...
features:
  - title: "Cosa sono i Campionati della Matematica?"
    ...
    button:
      enable: true
      label: "Approfondisci il funzionamento delle gare"
      link: "/funzionamento_campionati"

  - title: "Perché partecipare?"
    image: "/image/partecipare.png"
    content: "Partecipare ai Campionati della Matematica non significa soltanto competere, ma soprattutto mettersi alla prova, sviluppare capacità di ragionamento e confrontarsi con problemi nuovi e stimolanti.<br><br>
    La sfida non è tanto con gli altri studenti quanto con il problema stesso: un’occasione per migliorarsi, scoprire nuovi modi di pensare e vivere la matematica come attività creativa, curiosa e profondamente formativa."
    button:
      enable: true
      label: "Leggi perché ne vale la pena"
      link: "/partecipare"
